        ...
        switch(item.getItemId()) {
            case R.id.action_save:
                ...
                if (checkBoxAlarm.isChecked()){
                    ...
                    intent.putExtra("Description", alertContent);
                    ...
                    String NotificationTitle = mTitleText.getText().toString();
                    String NotificationContent=mDescriptionText.getText().toString();
                    intent.putExtra(getString(R.string.alert_title), NotificationTitle);
                    intent.putExtra(getString(R.string.alert_content), NotificationContent);
                ...
                openMainScreen.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
